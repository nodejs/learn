...
import { read, save } from './storage.mjs';
...
Note the use of time-zone here (`Z` in the time-stamps). Neglecting to include a consistent time-zone will likely lead to unexpected results.
